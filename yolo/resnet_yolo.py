...
"""
Source: Based on Resnet implementation from: https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py
Paper: https://www.cv-foundation.org/openaccess/content_cvpr_2016/papers/Redmon_You_Only_Look_CVPR_2016_paper.pdf
Joseph Redmon, Santosh Divvala, Ross Girshick, Ali Farhadi; The IEEE Conference on Computer Vision and Pattern Recognition (CVPR), 2016, pp. 779-788

Main architecture of the network. Using deep residual network.
"""
