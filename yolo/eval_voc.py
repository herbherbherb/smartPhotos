...
"""
Source: https://github.com/rbgirshick/py-faster-rcnn/blob/master/lib/datasets/voc_eval.py
Called when evaluating the mAP of the trained model
It is not called by server.py, used after the training
"""
