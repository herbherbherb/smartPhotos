...
"""
Predict function, given the model and input image, and returns detection result that contains
VOC class labels, box color, coordinates, class prob. 
This function is called by one of server.py POST method
"""

def decoder(pred):
    '''
    pred (tensor) 1xSxSx(B*5+C)  -- with resnet: 1x14x14x(2*5+20)
